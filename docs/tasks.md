...
- [ ] реализовать обработку WebSocket-сообщения { "type": "sticker", "payload": { "id": "stickerID" } } на сервере, при получении сервер должен определить автора и разослать всем участникам комнаты ответный JSON вида { "type": "sticker", "username": "...", "payload": { "id": "..." } }.
